...
const RangeSlider = ({ initialMin, initialMax, min, max, step, priceCap, yearSliderActive, setYearRange }) => {
  ...
  return (
    <div className={`${yearSliderActive ? 'absolute top-[4.2rem] grid place-items-center ' : 'hidden'}`}>
      <div className="flex flex-col w-56 bg-white shadow-xl rounded-lg px-6 py-1">
        <h1 className="text-xl font-medium text-rose-500 mb-1 text-center"> Enter Year range</h1>
